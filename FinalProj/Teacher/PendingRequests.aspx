<%@ Page Title="Pending Requests" Language="C#" AutoEventWireup="true" CodeBehind="PendingRequests.aspx.cs" Inherits="CanteenProject.Teacher.PendingRequests" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>BorrowBox Pro - Pending Requests</title>
    <style>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="header">
                <h1>🔐 BorrowBox Pro</h1>
                <p>Manage Student Borrow Requests</p>
            </div>
            ...
            <div class="dashboard">
                <div class="section-title">⏳ All Pending Borrow Requests</div>
