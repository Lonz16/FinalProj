<%@ Page Title="Activity Log" Language="C#" AutoEventWireup="true" CodeBehind="ActivityLog.aspx.cs" Inherits="CanteenProject.Admin.ActivityLog" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>BorrowBox Pro - Activity Log</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .action-logout { color: #f59e0b; }
        .action-register { color: #a78bfa; }
        .action-borrow { color: #60a5fa; }
        .action-return { color: #34d399; }
        .action-admin { color: #f87171; }
    </style>
</head>
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="dashboard">
                <div class="section-title">📋 All System Activities</div>
                ...
                <div class="filter-bar">
                    <asp:DropDownList ID="ddlActionType" runat="server">
                        ...
                        <asp:ListItem Text="Borrow Request" Value="Borrow Request" />
                        <asp:ListItem Text="Return Item" Value="Return Item" />
                        <asp:ListItem Text="Approve Request" Value="Approve Request" />
                        <asp:ListItem Text="Deny Request" Value="Deny Request" />
                    </asp:DropDownList>
                    <asp:Button ID="btnFilter" runat="server" Text="Filter" CssClass="btn-primary" OnClick="btnFilter_Click" />
                    <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn-primary" OnClick="btnClear_Click" style="background:#475569;" />
                </div>
