<%@ Page Title="My Borrowings" Language="C#" AutoEventWireup="true" CodeBehind="MyBorrowings.aspx.cs" Inherits="CanteenProject.Student.MyBorrowings" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>BorrowBox Pro - My Borrowings</title>
    <style>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="dashboard">
                <div class="section-title">📚 Currently Borrowed Items</div>
                <asp:GridView ID="gvActiveBorrows" runat="server" AutoGenerateColumns="False" OnRowCommand="gvActiveBorrows_RowCommand">
                    <Columns>
                        ...
                        <asp:ButtonField Text="Return" CommandName="Return" ButtonType="Button" ControlStyle-CssClass="btn-danger" />
                    </Columns>
                    <EmptyDataTemplate>
                        <tr>
                            <td colspan="4" style="text-align:center; padding:2rem;">✨ No active borrows</td>
                        </tr>
                    </EmptyDataTemplate>
                </asp:GridView>
                
                <div class="section-title" style="margin-top: 2rem;">📜 Borrowing History</div>
                <asp:GridView ID="gvHistory" runat="server" AutoGenerateColumns="True">
                    <EmptyDataTemplate>
                        <tr>
                            <td colspan="3" style="text-align:center; padding:2rem;">No borrowing history yet.</td>
                        </tr>
                    </EmptyDataTemplate>
                </asp:GridView>
